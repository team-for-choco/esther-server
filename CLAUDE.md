...
| 2026-02-28 | [20260228_merchant_price_adjustment.md](docs/20260228_merchant_price_adjustment.md) | CHOCO-125 | 상인 구매/판매 물품 조정 (Phase 11-4) | 완료 |
| 2026-02-28 | [20260228_texture_adjustment.md](docs/20260228_texture_adjustment.md) | CHOCO-126 | 텍스처 조정: 포탈 멀티블록 + 조리대/도감대 모델 (Phase 11-5) | 완료 |
| 2026-02-28 | [20260228_ore_detect_merchant_fix.md](docs/20260228_ore_detect_merchant_fix.md) | CHOCO-127 | 커스텀 광물 감지 + 상인 목록 보완 | 완료 |
| 2026-03-01 | [20260301_special_tool_protection.md](docs/20260301_special_tool_protection.md) | CHOCO-128 | 특수 도구 사망 보존 + 드롭/이동 제한 + 도구 슬롯 | 완료 |
| 2026-03-04 | - | CHOCO-129 | 인벤토리 세이브권 구현 | 완료 |
| 2026-04-04 | [20260404_town_return_scroll.md](docs/20260404_town_return_scroll.md) | CHOCO-131 | 마을 귀환서 구현 | 완료 |
| 2026-04-04 | - | CHOCO-132 | 마을 귀환서 획득처 추가: 뽑기 + 특수 상인 | 완료 |
| 2026-04-04 | [20260404_user_commands.md](docs/20260404_user_commands.md) | CHOCO-133 | 일반 사용자 명령어 한글화 | 완료 |
| 2026-04-05 | - | CHOCO-134 | fakeClaim 범위 일괄 처리 명령어 추가 (range / area) | 완료 |
| 2026-04-05 | [user_guide.md](docs/user_guide.md) | CHOCO-135 | 버그 수정 4종 + 유저 가이드 작성 (낚시 빈손 / 토지 세팅 전체 적용 / 전문 보관함 강화 인식 / 퀘스트 정보 한글화) | 완료 |
...
| 2026-04-07 | [20260407_early_game_balance.md](docs/20260407_early_game_balance.md) | CHOCO-141 | 초반부 완화: 특수 도구 비용 인하 + 낚시 시스템 개선 | 완료 |
| 2026-04-07 | [20260407_quest_translation_fix.md](docs/20260407_quest_translation_fix.md) | CHOCO-142 | 퀘스트 번역 중복 키 제거 + 아이템명 불일치 수정 | 완료 |
| 2026-04-07 | [20260407_enchant_merchant.md](docs/20260407_enchant_merchant.md) | CHOCO-143 | 인챈트 상인 NPC 구현 | 완료 |
| 2026-04-07 | [20260407_enchant_table_block.md](docs/20260407_enchant_table_block.md) | CHOCO-144 | 인챈트 테이블/모루 차단 | 완료 |
| 2026-04-08 | [20260408_fix_ore_loot_silk_touch.md](docs/20260408_fix_ore_loot_silk_touch.md) | CHOCO-145 | 특수 광물 루트 테이블 실크터치 조건 포맷 수정 (1.21.4 대응) | 완료 |
