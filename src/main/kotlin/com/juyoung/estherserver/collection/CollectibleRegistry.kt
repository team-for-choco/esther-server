...
object CollectibleRegistry {
    ...
    fun init() {
        ...
        // Minerals - Common (raw)
        register("estherserver:tin_ore_raw", CollectionCategory.MINERALS)
        register("estherserver:zinc_ore_raw", CollectionCategory.MINERALS)
        register("estherserver:jade_raw", CollectionCategory.MINERALS)
        // Minerals - Common (ingot)
        register("estherserver:tin_ingot", CollectionCategory.MINERALS)
        register("estherserver:zinc_ingot", CollectionCategory.MINERALS)
        // Minerals - Advanced (raw)
        register("estherserver:silver_ore_raw", CollectionCategory.MINERALS)
        register("estherserver:ruby_raw", CollectionCategory.MINERALS)
        register("estherserver:sapphire_raw", CollectionCategory.MINERALS)
        register("estherserver:titanium_ore_raw", CollectionCategory.MINERALS)
        // Minerals - Advanced (ingot)
        register("estherserver:silver_ingot", CollectionCategory.MINERALS)
        register("estherserver:titanium_ingot", CollectionCategory.MINERALS)
        // Minerals - Rare (raw)
        register("estherserver:platinum_ore_raw", CollectionCategory.MINERALS)
        register("estherserver:opal_raw", CollectionCategory.MINERALS)
        register("estherserver:tanzanite_raw", CollectionCategory.MINERALS)
        // Minerals - Rare (ingot)
        register("estherserver:platinum_ingot", CollectionCategory.MINERALS)
        // Special
        register("estherserver:obsidian_shard", CollectionCategory.MINERALS)
        ...
        register("estherserver:kimchi", CollectionCategory.COOKING)
        register("estherserver:kimchi_stew", CollectionCategory.COOKING)
        register("estherserver:miso_soup", CollectionCategory.COOKING)
        register("estherserver:grilled_mackerel", CollectionCategory.COOKING)
        register("estherserver:egg_rice", CollectionCategory.COOKING)
        // Cooking - Advanced (8)
        register("estherserver:sashimi_platter", CollectionCategory.COOKING)
        register("estherserver:eel_rice", CollectionCategory.COOKING)
        register("estherserver:dumpling", CollectionCategory.COOKING)
        register("estherserver:japchae", CollectionCategory.COOKING)
        register("estherserver:ramen", CollectionCategory.COOKING)
        register("estherserver:mapo_tofu", CollectionCategory.COOKING)
        register("estherserver:seafood_pancake", CollectionCategory.COOKING)
        register("estherserver:lotus_salad", CollectionCategory.COOKING)
        // Cooking - Rare (8)
        register("estherserver:ginseng_chicken", CollectionCategory.COOKING)
        register("estherserver:truffle_risotto", CollectionCategory.COOKING)
        register("estherserver:blowfish_sashimi", CollectionCategory.COOKING)
        register("estherserver:royal_bibimbap", CollectionCategory.COOKING)
        register("estherserver:matsutake_soup", CollectionCategory.COOKING)
        register("estherserver:saffron_rice", CollectionCategory.COOKING)
        register("estherserver:abalone_porridge", CollectionCategory.COOKING)
        register("estherserver:king_crab_stew", CollectionCategory.COOKING)
    }
